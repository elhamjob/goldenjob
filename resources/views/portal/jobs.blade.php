                ...
                <div class="packages_table table-responsive">
                  <table class="table-style3 table at-savesearch">
                    <thead class="t-head">
                        ...
                        <th scope="" colspan="7">
                          @if($jobcreditsc >=1)
                          <a href="{{ URL::route('addjob') }}" class="ud-btn btn-thm">Post  New Job</a>
                          @else
                           <a href="{{ URL::route('addjob') }}" class="ud-btn btn-thm">Post  New Job</a>
                        <!--   <span class="text-danger">insufficient creadit balance to post new job!</span><br>
                           <a href="javascript::void()" class="ud-btn btn-thm">Post New Job </a> -->
                           @endif
                    ...
                    <tbody class="t-body">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex">
                            <a href="{{ URL::route('editjob',$job->id) }}" class="icon me-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><span class="flaticon-pencil"></span></a>
                            <a href="{{ URL::route('deletejob',$job->id) }}" class="icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete"><span class="flaticon-delete"></span></a>
                          </div>
                        </td>
                      </tr>
                      @endforeach
