...
<style type="text/css">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Activity Management <small>insert, delete and update activity</small>
			</h3>
			...
			<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i> Add a New Activity - <span class="step-title">
								Step 1 of 3 </span>
							</div>
						...
						<div class="portlet-body form">
							{{Form::open(array('files' => true, 'url' => '/admin/post_activity','id'=>'submit_form','class'=>'form-horizontal'))}}
									...
									<div class="form-body">
										<ul class="nav nav-pills nav-justified steps">
											...
											<li>
												...
												4 </span>
												<span class="desc">
												<i class="fa fa-check"></i> Activity Info </span>
												</a>
											</li>
										</ul>
													...
													<div class="col-md-6">
														<select class="form-control" name="type">
															@foreach($actypes as $type)
																<option value="{{ $type->id }}">{{ $type->menu }}</option>
															@endforeach
														</select>
														<span class="help-block">
														This will be used for type </span>
													</div>
												</div>
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-6 calender">
														<input type="text" class="example1 form-control" name="activity_date" id="input1"/>
													</div>
												</div>
												<div class="form-group">
