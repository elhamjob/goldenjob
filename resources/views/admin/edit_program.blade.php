		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Edit Program</a>
					</li>
				</ul>
				
			</div>
			<h3 class="page-title">
			Edit Program <small>Edit a specific program</small>
			</h3>
			...
			<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i> Edit Program - <span class="step-title">
								Step 1 of 3 </span>
							</div>
						...
						<div class="portlet-body form">
							{{Form::open(array('files' => true, 'url' => '/admin/post_edit_program','id'=>'submit_form','class'=>'form-horizontal'))}}
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Program (EN) <span class="required">
													* </span>
													</label>
													<div class="col-md-8">
														<input type="text" value="{{ $program->title_en }}" class="form-control" name="title_english"/>
														<span class="help-block">
														Provide name in English </span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														    <textarea class="form-control" rows="8" name='text_english'>{{ $program->text_en }}</textarea>
														<span class="help-block">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													<label class="control-label col-md-3">Program Name (FA) <span class="required">
													* </span>
													</label>
													<div class="col-md-8">
														<input type="text" class="form-control" value="{{ $program->title_fa }}" name="title_farsi"/>
														<span class="help-block">
														Provide program name in Farsi </span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														    <textarea class="form-control" rows="8" name='text_farsi'>{{ $program->text_fa}}</textarea>
														<span class="help-block">
											...
											<div class="tab-pane" id="tab3">
												<h3 class="block">Provide Photo and Featured</h3>
												<div class="form-group">
