...
<style type="text/css">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Edit Activity <small>Edit a specific activity</small>
			</h3>
			...
			<div class="portlet box blue" id="form_wizard_1">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-pencil"></i> Edit Activity - <span class="step-title">
								Step 1 of 3 </span>
							</div>
						...
						<div class="portlet-body form">
							{{Form::open(array('files' => true, 'url' => '/admin/post_edit_activity','id'=>'submit_form','class'=>'form-horizontal'))}}
									...
									<div class="form-body">
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														<input type="text" value="{{ $activity->heading_en }}" class="form-control" name="title_english"/>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														<div id="">
														    <textarea id='editor1' style="margin-top: 30px;" name='text_english'>
														    	{{ $activity->text_en }}
														    </textarea>
														</div>
														<span class="help-block">
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														<input type="text" class="form-control" value="{{ $activity->heading_fa }}" name="title_farsi"/>
														<span class="help-block">
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-8">
														<div id="">
														    <textarea id='editor' style="margin-top: 30px;" name='text_farsi'>
														    	{{ $activity->text_fa }}
														    </textarea>
														</div>
														<span class="help-block">
											...
											<div class="tab-pane" id="tab3">
												<h3 class="block">Provide Photo and Type</h3>
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-6">
														<select class="form-control" name="type">
															<?php $mac = DB::table('main_nav')->where('id','=', $activity->type)->first(); ?>
															@if($mac)
															<option value="{{ $mac->id }}">{{ $mac->menu }}</option>
															@endif
															@foreach($actypes as $ac)
																<option value="{{ $ac->id }}">{{ $ac->menu }}</option>
															@endforeach
														</select>
														<span class="help-block">
														This will be used as a type </span>
													</div>
												</div>
												...
												<div class="form-group">
													...
													* </span>
													...
													<div class="col-md-6 calender">
														<input type="text" class="example1 form-control" name="activity_date" id="input1" value="<?=$activity->date?>"/>
													</div>
												</div>
												<div class="form-group">
