...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-7DC6XMRLE3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-7DC6XMRLE3');
</script>
<div class="wrapper">
    ...
    <div class="dashboard dashboard_wrapper pr30 pr0-xl">
      <div class="dashboard__sidebar d-none d-lg-block">
        <div class="dashboard_sidebar_list">
          ...
          <div class="sidebar_list_item ">
            <a href="{{ URL::route('seekerjobs') }}" class="items-center"><i class="flaticon-briefcase mr15"></i> Jobs</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="{{ URL::route('seekerrfps') }}" class="items-center"><i class="flaticon-briefcase mr15"></i> RFPs</a>
          </div>
          <div class="sidebar_list_item ">
            <a href="{{ URL::route('seekerrfqs') }}" class="items-center"><i class="flaticon-briefcase mr15"></i> RFQs</a>
          </div>
