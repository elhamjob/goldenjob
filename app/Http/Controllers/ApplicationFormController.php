...
class ApplicationFormController extends Controller
{
	...
	public function forms()
	{
		if(!Auth::check()){
           ...
           $rfps = forms::where('created_by',Auth::user()->id)->orderby('id',"desc")->get();
	    	return view('portal.forms')->with('rfps',$rfps);
	    }
	...
	public function editforms($id)
	{
		if(!Auth::check()){
	    	...
	    	$rfps = forms::where('id',$id)->orderby('id',"desc")->first();
	    		return view('portal.editforms')->with("rfps",$rfps);
	    }
	...
	public function deleteforms($id)
	{
		if(!Auth::check()){
	    	...
	    	$rfps = forms::where('id',$id)->orderby('id',"desc")->delete();
	...
	public function postforms(){
		...
		$destinationPath = 'projectsfiles/forms';
		...
		if($jobs->save())
		{
			...
			return Redirect::back()
            ->with('message','You   Successfully Posted a forms!');
		}
